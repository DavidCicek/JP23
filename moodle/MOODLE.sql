...
create table assign(
    ...
    infoformat smallint(4) not null,
...
/*alter table assign_user_flags add foreign key (userid) references user(id);*/
alter table assign_user_flags add foreign key (assignment) references assign(id);

/*alter table assignfeedback_file add foreign key (userid) references user(id);*/
...
/*alter table assign_user_mapping add foreign key (userid) references user(id)*/
