 ...
 * @author WEB DOG
 */
public class UcenikForma extends javax.swing.JFrame {

    private ObradaUcenik obrada;
    /**
     * Creates new form UcenikForma
     */
    public UcenikForma() {
        initComponents();
        obrada = new ObradaUcenik();
        setTitle(Aplikacija.NASLOV_APP + " | IZBORNIK UČENIKA");
        ucitaj();
    }
    ...
    private void initComponents() {
        ...
        lstUcenici.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                lstUceniciValueChanged(evt);
            }
        });
        jScrollPane1.setViewportView(lstUcenici);
    ...
    private void lstUceniciValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstUceniciValueChanged
        if (evt.getValueIsAdjusting()) {
            return;
        }
       
        if (lstUcenici.getSelectedValue() == null) {
            return;
        }
        
         obrada.setEntitet(lstUcenici.getSelectedValue());
    ...
    }//GEN-LAST:event_lstUceniciValueChanged

    private void btnDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDodajActionPerformed
        obrada.setEntitet(new Ucenik());
